  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md border-2 border-[#0a0a0a] bg-white p-8">
        <div className="mx-auto mb-6 grid size-14 place-items-center border-2 border-[#0a0a0a] bg-[#ffb900] text-[#0a0a0a]">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          <button
            ...
            className="h-12 border-2 border-[#0a0a0a] bg-[#ffb900] font-display text-xs font-extrabold uppercase tracking-[0.12em] text-[#0a0a0a] hover:bg-[#0a0a0a] hover:text-white"
          >
            Tentar novamente
          </button>
          <Link
