    ...
    <main className="bg-white pb-12">
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        <header className="border-2 border-[#0a0a0a] bg-white p-6">
          <p className="inline-block bg-[#ffc733] border border-[#0a0a0a] px-2 py-1 font-display text-xs font-extrabold uppercase tracking-[0.14em] text-[#0a0a0a]">
            Minha conta
          </p>
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="border-2 border-[#0a0a0a] bg-white p-5">
            ...
            <dl className="mt-4 space-y-3 font-sans text-sm">
              ...
              <div className="grid grid-cols-[120px_1fr] gap-2 border-2 border-[#ffc733] bg-[#ffc733] px-3 py-2">
          ...
          <div className="border-2 border-[#0a0a0a] bg-[#0a0a0a] p-5 text-white">
            <h2 className="border-b-2 border-[#ffc733] pb-2 font-display text-sm font-extrabold uppercase tracking-[0.12em] text-[#ffc733]">
              Participação
            </h2>
            ...
            <div className="mt-4 h-1 w-full bg-[#ffc733]" aria-hidden="true" />
          </div>
        </section>
      </div>
    </main>
