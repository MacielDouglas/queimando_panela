  ...
  return (
    <div className=" bg-pattern bg-cover">
      <div className="min-h-screen p-14 bg-pattern bg-cover ">
        <div className="p-14 mx-auto max-w-96 sm:max-w-xl md:max-w-2xl lg:max-w-3xl bg-stone-100 rounded-2xl shadow-2xl">
          <div className="flex flex-col md:flex-row md:items-center gap-5 ">
            <div className="flex-1">
              ...
              />
              <h1 className="text-center text-stone-800 mb-2 text-3xl font-bold font-oswald md:hidden">
            ...
            <div className="flex-1">
              ...
              <p className="text-stone-500 md:block hidden mb-4">
                Cadastra-se para publicar receita, comentar e pontuar.
              </p>
              <form className="flex flex-col gap-4" onSubmit={handleLogin}>
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className="border border-stone-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500"
                    required
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="bg-stone-800 text-white rounded-md py-2 px-4 hover:bg-stone-700 focus:outline-none focus:bg-stone-600 disabled:bg-stone-600"
                  // disabled={loading}
                >
              ...
              <div className="flex flex-col gap-2 text-sm mt-2 sm:flex-row">
                <p className="text-stone-500">Já tem cadastro?</p>
                <Link
                  to="/login"
